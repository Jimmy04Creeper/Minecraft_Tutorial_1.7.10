...
{
	private static Block log = Blockss.lightLog;
	private static Block leaves = Blockss.lightLeaves;
	...
	boolean validTreeLocation()
	{
		...
		if (block == Blockss.lightForestGrass || block == Blockss.lightForestGrass) {
			isSoil = true;
		}
